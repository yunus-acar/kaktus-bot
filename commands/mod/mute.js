...
class Mute extends Command {
	...
	async run (message, args, data) {
		...
		if(!member){
			return message.error("mod/mute:MISSING_MEMBER");
		}
		...
		member.send(message.translate("mod/mute:MUTED_DM", {
		...
		message.success("mod/mute:MUTED", {
		...
		if(data.guild.plugins.modlogs){
			...
			const embed = new Discord.MessageEmbed()
				.setAuthor(message.translate("mod/mute:CASE", {
