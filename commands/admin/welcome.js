...
class Welcome extends Command {
	...
	async run (message, args, data) {
		...
		if (
			...
			return message.success("admin/welcome:TEST_SUCCESS");
		}
		...
		if (
			...
			return message.error("admin/welcome:MISSING_STATUS");
		...
		if (args[0] === "off") {
			...
			data.guild.save();
			return message.error("admin/welcome:DISABLED", {
			...
			message.sendT("admin/welcome:FORM_1", {
			...
			collector.on("collect", async msg => {
				...
				if (welcome.message) {
					...
					message.sendT("admin/welcome:FORM_SUCCESS", {
						prefix: data.guild.prefix,
				...
				if (welcome.channel && !welcome.message) {
					if (msg.content.length < 1800) {
						...
						return message.sendT("admin/welcome:FORM_3");
					}
				...
				if (!welcome.channel) {
					...
					message.sendT("admin/welcome:FORM_2", {
